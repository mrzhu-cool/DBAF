...
class Highway(nn.Module):
    def __init__(self, size, num_layers, act="relu", momentum=0.1, share_weights=False):#size=256，num_layers=2
...
class StyleExtractionNet(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.fc1s = nn.ModuleList([nn.Linear(512, size) for _ in range(n_latent)])#modellist可以储存多个model，18层全连接层
